...
//             Console.Clear();
//             playlist.Sort();
//             foreach (Songs song in playlist) { // for every song in the playlist, write the song's ToString to the console
//                 if(song.Deleted != "y"){
...
//             playlist.Add(new Songs(){SongID = newID, SongTitle = PromptSongDetails(), SongTimestamp = DateTime.Now, Deleted = "n"});    
...
//         public int PromptSongToDelete(List<Songs> playlist) { // ask the user the ID of the song they want to delete
